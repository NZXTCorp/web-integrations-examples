const PRIVACY_DISCLAIMER = `NZXT Kraken Photo Slideshow's use and transfer of information received from Google APIs to any other app will adhere to [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including the Limited Use requirements.`

const PRIVACY_HEADER = `NZXT PRIVACY POLICY`
const PRIVACY_FOOTER = `
NZXT HQ

15736 E. Valley Blvd. 

City of Industry, CA 91744-3927
...
Your personal privacy and data security is important to us. This Privacy Policy explains how NZXT Inc. (we, us, our) collect and handle your personal data (personal information) in connection with our business, and when you access and use our services, which includes this website, [NZXT Kraken Photo Slideshow](https://nzxt-kraken-photo-slideshow.nzxt.com/), and the CAM app website [https://nzxt.com/software/cam](https://nzxt.com/software/cam) as well as any software, mobile applications, content and services (collectively “Services”).
...
*   Email: [privacy@nzxt.com](mailto:privacy@nzxt.com)
*   Post: NZXT Inc., Attention: Legal, 15736 E. Valley Blvd, City of Industry, CA 91744.
...
*   create an account to use the websites;
*   apply to be a NZXT Affiliate;
...
*   submit reviews, comments and posts on the websites (e.g. on the NZXT blog);
*   contact other users on the websites;
*   register to and/or attend our events;
*   submit a resume, an application to a job vacancy or attend an interview or assessment;
*   submit an application to join the NZXT affiliate program; and
*   ‘follow’, ‘like’, post to or interact with our social media accounts, including Facebook, LinkedIn, Twitter, Instagram, YouTube, Twitch, Steam, Reddit, Discord, and Google+.
...
*   **NZXT Account registration data.** Certain services may require that you register for an NZXT account. If you’re registering for an account you may also provide a username, password, date of birth, address, phone number and credit card information. If you choose to login through a social media account, for instance Facebook, Twitter, Google+ or Disqus, we will collect certain public information about the social media account you log in with, which will be notified at the time you grant permission to login through the account.
...
*   **Photos.** If you choose to share photos with us, for example, images to be used on our Build Gallery page, then you may provide personal information in the form of photos of you or other people.
*   Feedback and reviews. If you post on our websites, then you will provide details of any personal data that you share in the post, for instance, your username, your opinions, your experiences etc.
*   **Employment and background data.** If you are submitting a job application, you may provide information about your resume, cover letter, work availability dates, desired pay level, a link to your website/blog/portfolio, a link to your LinkedIn profile, you academic and work history, qualifications, skills, projects and research that you are involved in, answers to specific questions we ask in relation to the role you are applying for, references, proof of your entitlement to work (e.g. passport and visa), your national security number, drivers license, other identity document details, and any other such similar information that you may provide to us.
...
*   **Google APIs Data.** [NZXT Kraken Photo Slideshow](https://nzxt-kraken-photo-slideshow.nzxt.com/) use and transfer of information received from Google APIs to any other app will adhere to Google API Services User Data Policy, including the Limited Use requirements.
...
*   **Information transmitted on the websites.** We will collect information that you upload or post to your website account and/or any correspondence or interactions that you may have with other website users, for instance, if you comment on our blogs and have discussions with other NZXT users on the website.
*   **User System Data.** Our Services, including but not limited to our CAM software and service, collect the following types of personal information, non-personal, and other information about your User System: -- (i) hardware configuration and ID, e.g., including but not limited to, IP address, any computer names, certain data about components like fan speed, liquid temperature, cooling mode, lighting mode, custom mode detail, firmware version -- (ii) operating system and driver configuration - including but not limited to your user settings (things like your favorite colors, fan curves, custom images, build images, etc.) -- (iii) installed games and applications, including but not limited to games being played, game duration; -- (iv) games and applications settings, performance, and usage data, including but not limited to, CPU and GPU temperatures/loads, info about RAM, FPS statistics, monitor resolutions, system specs, Windows version, CAM version, RAM loads, drive capacity; and -- (v) usage metrics of our software or Services.
*   **Website usage data.** We will collect information about your interactions with the websites, including information such as login data, IP address, page views, searches, requests, orders, pre-approvals, confirmations, agreements between you and other website users and other actions on the websites.
...
*   **NZXT Affiliates.** We may receive personal information from NZXT Affiliates, such as details of sales referrals.
...
*   **Service providers.** We may collect personal information from our website developer, IT support provider, payment services provider, and HR and recruitment service provider (BambooHR) (who may be based inside or outside the EU).
...
*   website development and hosting services based in the USA, the Dominican Republic and Taiwan;
*   IT, system administration and security services based in the USA and Taiwan;
...
*   maps services (including Google Maps API), based in the USA;
*   social media plugin services including Facebook, Google+, Twitter, and LinkedIn based in the USA;'
*   payment services based in the USA;
*   identity verification, fraud prevention and detection services based in the USA;
*   banking services based in Germany and the USA;
*   legal, accountancy, auditing and insurance services and other professional advisers based in the USA, the United Kingdom, Germany and the Netherlands;
*   recruitment service providers based in the USA, the United Kingdom and Taiwan;
...
5.1.9 the right to lodge a complaint about us to the UK Information Commissioner’s Office ([https://ico.org.uk/](https://ico.org.uk/)) as well as a right to lodge a complaint with the relevant authority in your country of work or residence.
...
5.2.1 You may exercise your rights above by contacting us at [privacy@nzxt.com](mailto:privacy@nzxt.com) or NZXT Inc., Attention: Legal, 13164 E. Temple Ave., City of Industry, CA 91746, or in the case of preventing processing for marketing activities also by checking certain boxes on forms that we use to collect your data to tell us that you don’t want to be involved in marketing, using the unsubscribe link at the bottom of the email.
...
8.4.3 Where we use providers based in the US, we may transfer data to them if they are part of the Privacy Shield which requires them to provide similar protection to personal data shared between the Europe and the US. For further details, see European Commission: [EU-US Privacy Shield](https://www.privacyshield.gov/welcome).
...
11.1 The websites may include links to third-party websites, plug-ins and applications. Clicking on those links or enabling those connections may allow third parties to collect or share data about you. We do not control these third-party websites and are not responsible for their privacy statements. When you leave our websites, we encourage you to read the privacy policy of every website you visit.

12. **Changes**

12.1 We may periodically update this Policy. We’ll notify you about significant changes to it. You should periodically check [https://www.nzxt.com/privacy-policy](https://www.nzxt.com/privacy-policy) or this privacy page for updates.
...
export { PRIVACY_DISCLAIMER, PRIVACY_CONTENT, PRIVACY_HEADER, PRIVACY_FOOTER }
